...
public class ParasiteDetected extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.parasitedetected);
	...
	protected void processImage() {
		try {
			...
			IplImage originalImage = cvLoadImage(new File(
					"/sdcard/ocula/rawimage.jpg").getAbsolutePath());
			new File(new File("/sdcard/ocula/rawimage.jpg").getAbsolutePath())
					.delete();
			...
			cvSaveImage(
					new File("/sdcard/ocula/parasite.jpg").getAbsolutePath(),
					grayImage);
			...
			// read and display
			img = (ImageView) findViewById(R.id.parasite);
			...
			img.setImageURI(Uri.parse(new File("/sdcard/ocula/parasite.jpg")
					.getAbsolutePath()));

			new File(new File("/sdcard/ocula/parasite.jpg").getAbsolutePath())
					.delete();
