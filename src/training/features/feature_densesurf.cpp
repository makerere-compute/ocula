/*
Calculate SURF descriptor at regular positions on a grid
...
where d1 ... d64 are the SURF descriptor values.

Compile with:
g++ `pkg-config --cflags opencv` -lopencv_core -lopencv_features2d -o feature_densesurf feature_densesurf.cpp
*/
